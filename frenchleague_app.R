...
library(pacman)
p_load(tidyverse, engsoccerdata, shiny, DT, shinythemes, scales,
       ggthemes, plotly, RColorBrewer, readr, foreign)
...
###############################################################
####### data transformation and wrangling for tab 3 & 4 #######
###############################################################
...
# I manually removed those 6 cases - could have written an if statement but lazy 
  ...
  sidebarLayout(
    ...
    sidebarPanel(
      ...
      conditionalPanel(
        ...
        helpText(p("Any suggestion for improvement would be greatly appreciated and if you have errors to report or comments to make, please contact",
    ...
    mainPanel(
      ...
      tabsetPanel(
        ...
        tabPanel('Ligue 1 Champions', br(), 
                 img(src = "champions.jpg", height = 294, width = 441), 
                 img(src='champions4.jpg', height = 294, width = 441, align = "right"),
                 img(src = "champions2.jpg", height = 294, width = 441), 
                 img(src='champions3.jpg', height = 294, width = 441, align = "right"), 
                 br(), br(), 
        ...
        tabPanel('Download Raw Data',
                 br(), 
                 h2("Select your preferred filetype and variables to be included, then hit 'Download Data' to download the raw data"),
                 br(), br(), br(), 
                 downloadButton(outputId = "download_data", label = "Download Data"), 
                br(), br(), br(),
                 h3(HTML(paste0("The data comes from Professor James Curley’s GitHub repository ", 
...
server <- function(input, output, session) {
  ...
  france_raw <- france_raw %>% 
    mutate(matchid = row_number(Season))
  ...
  #### reactive 2 defined with reactive 1
